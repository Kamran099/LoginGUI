...
public class LoginSystem implements ActionListener{
	...
	@Override
	public void actionPerformed(ActionEvent e) {  // this code is run every time the button is run
		// TODO Auto-generated method stub
		String user = userText.getText();
		String password = passwordText.getText();
		System.out.println("Username entered:" + user + " Password entered:" + password);
